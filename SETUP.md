...
course of action would be to use the pinkish login button located at the bottom of your screen which opens up reddit in your default browser for you to login. Keep in mind this method tends to not work with hardend browsers like Fennec. Here are some of the browsers which are guarenteed to work with this method; 
